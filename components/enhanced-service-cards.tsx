...
import { RegularCleaningIcon, DeepCleaningIcon, MoveCleaningIcon, OfficeCleaningIcon } from "@/components/icons"
...
export default function EnhancedServiceCards() {
  ...
  const services: Service[] = [
    {
      ...
      icon: <RegularCleaningIcon className="h-6 w-6" />,
      price: "$120",
      popular: true,
      features: [
    ...
    },
    {
      ...
      icon: <DeepCleaningIcon className="h-6 w-6" />,
      price: "$220",
      features: [
    ...
    },
    {
      ...
      icon: <MoveCleaningIcon className="h-6 w-6" />,
      price: "$320",
      features: [
    ...
    },
    {
      ...
      icon: <OfficeCleaningIcon className="h-6 w-6" />,
      price: "Custom",
      features: [
  ...
  return (
    <div className="py-12 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50 dark:from-gray-950 dark:to-gray-900">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div
                      className={`p-3 rounded-full ${
                        hoveredService === service.id ? "bg-primary text-white" : "bg-primary/10 text-primary"
                      }`}
                    >
                      {service.icon}
                    </div>
