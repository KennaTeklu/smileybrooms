    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-4 right-4 z-50" // This div handles the fixed positioning
        >
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <Button
                variant="default"
                size="lg"
                // Removed fixed positioning from here, handled by parent motion.div
                className="rounded-full shadow-lg h-16 w-16 md:h-20 md:w-20 flex flex-col items-center justify-center text-white bg-blue-600 hover:bg-blue-700 transition-all duration-300 ease-in-out transform hover:scale-105"
