    ...
    <AnimatePresence initial={false}>
      {isOpen ? (
        <motion.div
          ...
          className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full sm:max-w-sm md:max-w-md lg:max-w-lg bg-transparent backdrop-blur-xl rounded-t-2xl shadow-2xl overflow-hidden border-t-2 border-l-2 border-r-2 border-purple-200/50 dark:border-purple-800/50 z-20"
          style={{
