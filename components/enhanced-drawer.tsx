...
export interface EnhancedDrawerProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof drawerVariants> {
  open?: boolean
  onClose?: () => void
...
export const EnhancedDrawerTrigger = ({
  children,
  onClick,
  ...props
...
export const EnhancedDrawerContent = ({ children, className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("p-6", className)} {...props}>
    {children}
  </div>
)

export const EnhancedDrawerHeader = ({ children, className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("mb-4 pb-4 border-b", className)} {...props}>
    {children}
  </div>
)

export const EnhancedDrawerFooter = ({ children, className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("mt-auto pt-4 border-t", className)} {...props}>
    {children}
  </div>
)

export const EnhancedDrawerClose = ({
  children,
  onClick,
  ...props
