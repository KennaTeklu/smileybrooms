      ...
      <div className="calculator-display flex-1 md:mr-8">
        <form id="price-calculator" className="space-y-8">
          ...
          <Collapsible>
            <CollapsibleTrigger asChild>
              <Button variant="outline" size="sm" className="w-full justify-between">
                Service Type <ChevronDown className="h-4 w-4 shrink-0 opacity-50" />
              </Button>
            </CollapsibleTrigger>
          ...
          <Collapsible>
            <CollapsibleTrigger asChild>
              <Button variant="outline" size="sm" className="w-full justify-between">
                Cleanliness Level <ChevronDown className="h-4 w-4 shrink-0 opacity-50" />
              </Button>
            </CollapsibleTrigger>
            <CollapsibleContent className="pl-4">
          ...
          {/* Room Selection - Always open, not collapsible */}
          <div>
            <h3 className="font-medium text-lg mb-4">Select Rooms to Clean</h3>
            <div className="mt-4">
