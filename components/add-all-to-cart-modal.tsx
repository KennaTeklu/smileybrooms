...
import { ScrollAwareWrapper } from "@/components/scroll-aware-wrapper" // Import ScrollAwareWrapper
  ...
  return (
    <TooltipProvider>
      <ScrollAwareWrapper
        side="right"
        config={{
          defaultPosition: "top", // Start at the top
          scrollPosition: "top", // Stick to the top
          offset: { top: 72, right: 20 }, // 64px (header height) + 8px (gap) = 72px
        }}
      >
        <motion.div
          ...
          className="relative z-50" // Removed fixed positioning, ScrollAwareWrapper handles it
        >
