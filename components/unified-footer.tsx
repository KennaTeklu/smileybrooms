      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className="container max-w-7xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12 text-sm cursor-pointer hover:bg-gray-800/50 transition-colors duration-200 rounded-lg p-4"
              onClick={() => {
                toast({
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Dedicated to providing exceptional cleaning services with a focus on customer satisfaction and
