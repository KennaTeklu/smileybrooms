...
export function CollapsibleSharePanel() {
  ...
  useEffect(() => {
    registerPanel("sharePanel", { isFullscreen: false, zIndex: 1000 })
  ...
  const panelZIndex = getPanelConfig("sharePanel")?.zIndex || 1000 // Higher z-index
