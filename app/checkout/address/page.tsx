...
export default function AddressStep({ data, onSave, onNext, onPrevious }: AddressStepProps) {
  ...
  // This useEffect is not strictly necessary if data is passed as prop and managed by parent,
  // but it ensures internal state is synced if parent data changes.
  useEffect(() => {
    setAddressData(data)
  }, [data])
