...
import CheckoutSidePanel from '@/components/cart/checkout-sidepanel' // Import the new side panel component
import type \{ CheckoutData \} from '@/lib/types' // Import CheckoutData type
...
export default function CartPage() \{
  ...
  // New states for side panel and completed data
  ...
  const confirmRemoveItem = () => \{
    if (itemToRemoveId) \{
      ...
      // If cart becomes empty after removal, reset completed checkout data
  ...
  const confirmClearCart = () => \{
    ...
    setCompletedCheckoutData(null); // Clear completed data when cart is cleared
  \}
    ...
    <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-64px)] flex flex-col">
      ...
      \{(cart.items?.length ?? 0) === 0 ? (
        ...
        <div className="grid lg:grid-cols-3 gap-8 flex-1">
          ...
          \{/* Conditional "Proceed to Checkout" button or Order Summary */\}
                  ...
                  <CheckoutButton
                    ...
                    customerData=\{\{
                      ...
                      address: \{
                        ...
                        country: 'US', // Assuming US for now, adjust if country selection is added
                      \},
                    \}\}
                  />
                  <Button
