...
export const defaultAddOns: Record<string, RoomAddOn[]> = {
  ...
  bathroom: [
    ...
    { id: "bath-2", name: "Grout detailed scrubbing", price: 7.50, description: "Deep cleaning of tile grout" },
    {
      id: "bath-3",
    ...
    { id: "bath-5", name: "Mold/mildew treatment", price: 6.25, description: "Treatment of mold and mildew spots" },
  ],
  kitchen: [
    {
      id: "kit-1",
    ...
    { id: "kit-2", name: "Inside oven cleaning", price: 8.75, description: "Deep cleaning of oven interior" },
    {
      id: "kit-3",
  ...
  livingRoom: [
    ...
    { id: "liv-4", name: "Window treatment dusting", price: 4.50, description: "Dusting of curtains and blinds" },
    { id: "liv-5", name: "Decor item individual cleaning", price: 3.00, description: "Cleaning of decorative items" },
  ],
  diningRoom: [
    { id: "din-1", name: "China cabinet interior cleaning", price: 6.25, description: "Cleaning inside china cabinet" },
  ...
  homeOffice: [
    ...
    { id: "off-3", name: "Bookshelf organization", price: 6.25, description: "Organization of books and materials" },
    { id: "off-4", name: "Cable management", price: 3.75, description: "Organization and securing of cables" },
    { id: "off-5", name: "Desk drawer organization", price: 4.50, description: "Organization of desk drawer contents" },
  ],
  laundryRoom: [
    { id: "lau-1", name: "Washer deep cleaning", price: 6.25, description: "Deep cleaning of washing machine" },
    { id: "lau-2", name: "Dryer vent cleaning", price: 5.00, description: "Cleaning of dryer vent and lint trap" },
    { id: "lau-3", name: "Supply organization", price: 3.75, description: "Organization of laundry supplies" },
    { id: "lau-4", name: "Under appliance cleaning", price: 4.50, description: "Cleaning under washer and dryer" },
    { id: "lau-5", name: "Utility sink deep clean", price: 3.75, description: "Deep cleaning of laundry sink" },
  ],
  entryway: [
    { id: "ent-1", name: "Shoe organization", price: 3.75, description: "Organization of shoes and boots" },
    ...
    { id: "ent-5", name: "Mail/key area organization", price: 3.75, description: "Organization of mail and key area" },
  ],
  hallway: [
    {
      id: "hal-1",
  ...
  stairs: [
    { id: "sta-1", name: "Carpet deep cleaning", price: 6.25, description: "Deep cleaning of stair carpet" },
    {
      id: "sta-2",
    ...
    { id: "sta-3", name: "Stair riser cleaning", price: 3.75, description: "Cleaning of stair risers" },
    {
      id: "sta-4",
  ...
  default: [
    ...
    { id: "def-4", name: "Light fixture cleaning", price: 2.50, description: "Cleaning of light fixtures" },
    { id: "def-5", name: "Door/doorframe cleaning", price: 2.50, description: "Cleaning of doors and doorframes" },
  ],
}
