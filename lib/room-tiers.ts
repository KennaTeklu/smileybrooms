  ...
  default: [
    {
      ...
      detailedTasks: [
        ...
        "Emptying trash bins - Emptying all trash bins and replacing liners",
        "Wiping light switches and doorknobs - Quick wipe-down of high-touch areas",
        "Mirror spot cleaning - Quick wipe of mirrors to remove obvious smudges",
      ],
      notIncludedTasks: [
    ...
    },
    {
      ...
      detailedTasks: [
        ...
        "Floor detailed cleaning - Deep vacuuming or mopping of all floor areas, including edges and under light furniture",
        "Baseboard attention - Wiping down all baseboards and trim",
        "Surface sanitizing - Sanitizing high-touch surfaces (e.g., doorknobs, light switches, countertops)",
        "Trash removal - Emptying all trash bins and replacing liners",
        "Interior window spot cleaning - Cleaning visible smudges and fingerprints on interior windows",
        "Appliance exterior wipe-down - Wiping down exteriors of kitchen appliances (refrigerator, oven, dishwasher)",
        "Bathroom fixture polishing - Polishing faucets and showerheads",
        "Kitchen sink deep clean - Scrubbing and sanitizing kitchen sink and faucet",
        "Bed making (basic) - Making beds with existing linens",
        "Light organization of common areas - Tidying up living room, dining room, and entryway",
      ],
      notIncludedTasks: [
        ...
        "✗ Hard-to-reach areas (e.g., high shelves, inside cabinets, behind heavy furniture)",
        "✗ Aromatherapy finishing",
        "✗ Extensive wall spot cleaning (beyond minor marks)",
        "✗ Ceiling corner cobweb removal (beyond easy reach)",
        "✗ Inside oven/refrigerator/dishwasher cleaning",
        "✗ Laundry washing/folding",
        "✗ Organizing personal items (e.g., clothes, papers, toys, drawers)",
        "✗ Grout deep cleaning",
        "✗ Carpet shampooing",
        "✗ Exterior cleaning",
      ],
    ...
    },
    {
      ...
      detailedTasks: [
        "ALL Advanced tasks",
        "Specialty surface treatment - Cleaning and conditioning of special surfaces (e.g., leather, marble, stainless steel)",
        "Detail work on fixtures - Detailed cleaning of light fixtures, faucets, and hardware, including disassembling if needed",
        "Hard-to-reach areas - Cleaning of high shelves, inside cabinets (if empty), behind and under all furniture (moved by cleaners)",
        "Aromatherapy finishing - Application of essential oil mist for a fresh scent throughout the home",
        "Wall spot cleaning - Thorough spot cleaning of all walls for marks and smudges",
        "Ceiling corner cleaning - Removal of cobwebs and dust from all ceiling corners and crown molding",
        "Door and doorframe cleaning - Detailed cleaning of all doors, doorframes, and hinges",
        "Light fixture detailed cleaning - Disassembling and deep cleaning of all light fixtures and ceiling fans",
        "Air vent cleaning - Removing and deep cleaning all air vent covers",
        "Furniture polishing - Polishing and conditioning of all wood furniture and leather items",
        "Decor item individual cleaning - Individually cleaning and polishing all decorative items, picture frames, and artwork",
        "Inside oven/refrigerator/dishwasher cleaning - Deep cleaning of appliance interiors",
        "Grout deep cleaning - Scrubbing and sanitizing all tile grout in bathrooms and kitchen",
        "Carpet spot treatment - Treating and removing visible stains on carpets",
        "Laundry folding (up to 1 load) - Folding one load of laundry if left in the machine",
        "Cabinet interior wipe-down (if empty) - Wiping down the interior of empty cabinets and drawers",
      ],
      notIncludedTasks: [
        "✗ Extensive organization of personal belongings (e.g., sorting clothes, papers, toys in drawers/closets)",
        "✗ Washing dishes (beyond basic sink cleanup)",
        "✗ Exterior window cleaning",
        "✗ Moving heavy furniture or appliances not specified for cleaning underneath",
        "✗ Biohazard cleanup (e.g., mold remediation, excessive pet waste)",
        "✗ Post-construction or renovation cleanup (excessive dust/debris)",
        "✗ Pest control",
        "✗ Exterior cleaning (e.g., patios, garages, driveways)",
      ],
    },
  ],
}
