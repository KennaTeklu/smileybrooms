...
export const defaultAddOns: Record<string, RoomAddOn[]> = {
  bedroom: [
    ...
    { id: "bed-3", name: "Curtain/shade vacuuming", price: 0.75, description: "Dust removal from window treatments" },
    {
      id: "bed-4",
  ...
  bathroom: [
    ...
    { id: "bath-2", name: "Grout detailed scrubbing", price: 1.88, description: "Deep cleaning of tile grout" },
    {
      id: "bath-3",
    ...
    { id: "bath-4", name: "Exhaust fan cleaning", price: 0.75, description: "Cleaning of bathroom exhaust fan" },
    { id: "bath-5", name: "Mold/mildew treatment", price: 1.56, description: "Treatment of mold and mildew spots" },
  ],
  kitchen: [
    {
      id: "kit-1",
    ...
    { id: "kit-2", name: "Inside oven cleaning", price: 2.19, description: "Deep cleaning of oven interior" },
    {
      id: "kit-3",
    ...
    { id: "kit-4", name: "Dishwasher deep clean", price: 1.25, description: "Detailed cleaning of dishwasher" },
    {
      id: "kit-5",
  ...
  livingRoom: [
    ...
    { id: "liv-4", name: "Window treatment dusting", price: 1.12, description: "Dusting of curtains and blinds" },
    { id: "liv-5", name: "Decor item individual cleaning", price: 0.75, description: "Cleaning of decorative items" },
  ],
  diningRoom: [
    { id: "din-1", name: "China cabinet interior cleaning", price: 1.56, description: "Cleaning inside china cabinet" },
    { id: "din-2", name: "Chair upholstery cleaning", price: 1.25, description: "Cleaning of dining chair upholstery" },
    {
      id: "din-3",
  ...
  homeOffice: [
    ...
    { id: "off-3", name: "Bookshelf organization", price: 1.56, description: "Organization of books and materials" },
    { id: "off-4", name: "Cable management", price: 0.94, description: "Organization and securing of cables" },
    { id: "off-5", name: "Desk drawer organization", price: 1.12, description: "Organization of desk drawer contents" },
  ],
  laundryRoom: [
    { id: "lau-1", name: "Washer deep cleaning", price: 1.56, description: "Deep cleaning of washing machine" },
    { id: "lau-2", name: "Dryer vent cleaning", price: 1.25, description: "Cleaning of dryer vent and lint trap" },
    { id: "lau-3", name: "Supply organization", price: 0.94, description: "Organization of laundry supplies" },
    { id: "lau-4", name: "Under appliance cleaning", price: 1.12, description: "Cleaning under washer and dryer" },
    { id: "lau-5", name: "Utility sink deep clean", price: 0.94, description: "Deep cleaning of laundry sink" },
  ],
  entryway: [
    { id: "ent-1", name: "Shoe organization", price: 0.94, description: "Organization of shoes and boots" },
    { id: "ent-2", name: "Coat closet organization", price: 1.25, description: "Organization of coat closet contents" },
    { id: "ent-3", name: "Entry mat deep cleaning", price: 0.75, description: "Deep cleaning of entry mats" },
    {
      id: "ent-4",
    ...
    { id: "ent-5", name: "Mail/key area organization", price: 0.94, description: "Organization of mail and key area" },
  ],
  hallway: [
    {
      id: "hal-1",
    ...
    { id: "hal-5", name: "Wall sconce cleaning", price: 0.75, description: "Cleaning of wall sconces" },
  ],
  stairs: [
    { id: "sta-1", name: "Carpet deep cleaning", price: 1.56, description: "Deep cleaning of stair carpet" },
    {
      id: "sta-2",
    ...
    { id: "sta-3", name: "Stair riser cleaning", price: 0.94, description: "Cleaning of stair risers" },
    {
      id: "sta-4",
  ...
  default: [
    ...
    { id: "def-2", name: "Wall spot cleaning", price: 0.75, description: "Cleaning of wall spots and marks" },
    {
      id: "def-3",
    ...
    { id: "def-4", name: "Light fixture cleaning", price: 0.62, description: "Cleaning of light fixtures" },
    { id: "def-5", name: "Door/doorframe cleaning", price: 0.62, description: "Cleaning of doors and doorframes" },
  ],
}
