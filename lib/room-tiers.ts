  ...
  default: [
    {
      ...
      detailedTasks: [
        "Surface dusting - Dusting of all accessible surfaces (e.g., tables, shelves, desks)",
        "Floor vacuum/sweep - Vacuuming or sweeping of main floor areas",
        "General tidying - Straightening up items, light organization of clutter",
      ],
      notIncludedTasks: [
        "✗ Detailed dusting",
        "✗ Floor detailed cleaning",
    ...
    },
    {
      ...
      detailedTasks: [
        "ALL Essential tasks",
        "Detailed dusting - Thorough dusting of all surfaces, including decor and electronics",
        "Floor detailed cleaning - Deep vacuuming or mopping of all floor areas, including edges",
        "Baseboard attention - Wiping down all baseboards and trim",
        "Surface sanitizing - Sanitizing high-touch surfaces (e.g., doorknobs, light switches)",
    ...
    },
    {
      ...
      detailedTasks: [
        "ALL Advanced tasks",
        "Specialty surface treatment - Cleaning and conditioning of special surfaces (e.g., leather, marble)",
        "Detail work on fixtures - Detailed cleaning of light fixtures, faucets, and hardware",
        "Hard-to-reach areas - Cleaning of high shelves, behind furniture, and other difficult spots",
        "Aromatherapy finishing - Application of essential oil mist for a fresh scent",
        "Wall spot cleaning - Thorough spot cleaning of all walls for marks and smudges",
        "Ceiling corner cleaning - Removal of cobwebs and dust from all ceiling corners",
        "Door and doorframe cleaning - Detailed cleaning of all doors and doorframes",
        "Light fixture detailed cleaning - Disassembling and deep cleaning of all light fixtures",
        "Air vent cleaning - Removing and deep cleaning all air vent covers",
        "Furniture polishing - Polishing and conditioning of all wood furniture",
        "Decor item individual cleaning - Individually cleaning and polishing all decorative items",
      ],
      notIncludedTasks: [],
    },
  ],
