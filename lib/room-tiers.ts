  ...
  other: [
    {
      id: "other-essential",
      name: "ESSENTIAL CLEAN",
      price: 0.00, // Price is 0, will show "Email for Pricing"
...
export const defaultAddOns: Record<string, RoomAddOn[]> = {
  bedroom: [
    ...
    { id: "bed-3", name: "Curtain/shade vacuuming", price: 3.00, description: "Dust removal from window treatments" },
    {
      id: "bed-4",
  ...
  bathroom: [
    ...
    { id: "bath-2", name: "Grout detailed scrubbing", price: 7.52, description: "Deep cleaning of tile grout" },
    {
      id: "bath-3",
    ...
    { id: "bath-4", name: "Exhaust fan cleaning", price: 3.00, description: "Cleaning of bathroom exhaust fan" },
    { id: "bath-5", name: "Mold/mildew treatment", price: 6.24, description: "Treatment of mold and mildew spots" },
  ],
  kitchen: [
    {
      id: "kit-1",
    ...
    { id: "kit-2", name: "Inside oven cleaning", price: 8.76, description: "Deep cleaning of oven interior" },
    {
      id: "kit-3",
    ...
    { id: "kit-4", name: "Dishwasher deep clean", price: 5.00, description: "Detailed cleaning of dishwasher" },
    {
      id: "kit-5",
  ...
  livingRoom: [
    ...
    { id: "liv-4", name: "Window treatment dusting", price: 4.48, description: "Dusting of curtains and blinds" },
    { id: "liv-5", name: "Decor item individual cleaning", price: 3.00, description: "Cleaning of decorative items" },
  ],
  diningRoom: [
    { id: "din-1", name: "China cabinet interior cleaning", price: 6.24, description: "Cleaning inside china cabinet" },
    { id: "din-2", name: "Chair upholstery cleaning", price: 5.00, description: "Cleaning of dining chair upholstery" },
    {
      id: "din-3",
  ...
  homeOffice: [
    ...
    { id: "off-3", name: "Bookshelf organization", price: 6.24, description: "Organization of books and materials" },
    { id: "off-4", name: "Cable management", price: 3.76, description: "Organization and securing of cables" },
    { id: "off-5", name: "Desk drawer organization", price: 4.48, description: "Organization of desk drawer contents" },
  ],
  laundryRoom: [
    { id: "lau-1", name: "Washer deep cleaning", price: 6.24, description: "Deep cleaning of washing machine" },
    { id: "lau-2", name: "Dryer vent cleaning", price: 5.00, description: "Cleaning of dryer vent and lint trap" },
    { id: "lau-3", name: "Supply organization", price: 3.76, description: "Organization of laundry supplies" },
    { id: "lau-4", name: "Under appliance cleaning", price: 4.48, description: "Cleaning under washer and dryer" },
    { id: "lau-5", name: "Utility sink deep clean", price: 3.76, description: "Deep cleaning of laundry sink" },
  ],
  entryway: [
    { id: "ent-1", name: "Shoe organization", price: 3.76, description: "Organization of shoes and boots" },
    { id: "ent-2", name: "Coat closet organization", price: 5.00, description: "Organization of coat closet contents" },
    { id: "ent-3", name: "Entry mat deep cleaning", price: 3.00, description: "Deep cleaning of entry mats" },
    {
      id: "ent-4",
    ...
    { id: "ent-5", name: "Mail/key area organization", price: 3.76, description: "Organization of mail and key area" },
  ],
  hallway: [
    {
      id: "hal-1",
    ...
    { id: "hal-5", name: "Wall sconce cleaning", price: 3.00, description: "Cleaning of wall sconces" },
  ],
  stairs: [
    { id: "sta-1", name: "Carpet deep cleaning", price: 6.24, description: "Deep cleaning of stair carpet" },
    {
      id: "sta-2",
    ...
    { id: "sta-3", name: "Stair riser cleaning", price: 3.76, description: "Cleaning of stair risers" },
    {
      id: "sta-4",
  ...
  default: [
    ...
    { id: "def-2", name: "Wall spot cleaning", price: 3.00, description: "Cleaning of wall spots and marks" },
    {
      id: "def-3",
    ...
    { id: "def-4", name: "Light fixture cleaning", price: 2.48, description: "Cleaning of light fixtures" },
    { id: "def-5", name: "Door/doorframe cleaning", price: 2.48, description: "Cleaning of doors and doorframes" },
  ],
}
